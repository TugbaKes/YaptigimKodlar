...
public class GirisYapilanAraliktakiCiftSayilar {
    ...
    public static void baslikProgram(){
        System.out.println(ConsoleColors.RED_BOLD+"Belirtilen Aralıktaki Çift Sayıları Gösteren Program"+ConsoleColors.RESET);
    }
